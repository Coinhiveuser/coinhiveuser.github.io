...
| 12/10    | 日経電子版にて、マイニングスクリプトの違法となる可能性が初めて指摘された記事「[仮想通貨で不正サイト　『採掘』を無断で手伝わせる](https://www.nikkei.com/article/DGXMZO24462980Z01C17A2SHA000/) 」が公開 |
...
無駄な程に細かく書いていますが、気にしないでください。

(一応これを使えば警察・検察がどの時点でのCoinhiveウェブサイトのアーカイブを使っているかを見分ける事が出来るはずです)
